...
add wave -noupdate -format Analog-Step -height 74 -max 57.0 -radix hexadecimal /STOSAvectorial_tb/uut/matrix_control_u/counter_up
...
add wave -noupdate -format Analog-Step -height 74 -max 126.0 -radix unsigned -childformat {{/STOSAvectorial_tb/uut/CTRLattenuator(6) -radix unsigned} {/STOSAvectorial_tb/uut/CTRLattenuator(5) -radix unsigned} {/STOSAvectorial_tb/uut/CTRLattenuator(4) -radix unsigned} {/STOSAvectorial_tb/uut/CTRLattenuator(3) -radix unsigned} {/STOSAvectorial_tb/uut/CTRLattenuator(2) -radix unsigned} {/STOSAvectorial_tb/uut/CTRLattenuator(1) -radix unsigned} {/STOSAvectorial_tb/uut/CTRLattenuator(0) -radix unsigned}} -subitemconfig {/STOSAvectorial_tb/uut/CTRL_port(6) {-radix unsigned} /STOSAvectorial_tb/uut/CTRL_port(5) {-radix unsigned} /STOSAvectorial_tb/uut/CTRL_port(4) {-radix unsigned} /STOSAvectorial_tb/uut/CTRL_port(3) {-radix unsigned} /STOSAvectorial_tb/uut/CTRL_port(2) {-radix unsigned} /STOSAvectorial_tb/uut/CTRL_port(1) {-radix unsigned} /STOSAvectorial_tb/uut/CTRL_port(0) {-radix unsigned}} /STOSAvectorial_tb/uut/CTRLattenuator
...
add wave -noupdate /STOSAvectorial_tb/uut/clk_SPIN_port
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {1744500000 ps} 0}
...
update
WaveRestoreZoom {1090660362 ps} {2318314506 ps}
