...
add wave -noupdate -format Analog-Step -height 74 -max 57.0 -radix decimal /STOSAvectorial_tb/uut/matrix_control_u/counter_up
...
WaveRestoreCursors {{Cursor 1} {1942938413 ps} 0}
...
update
WaveRestoreZoom {1927854671 ps} {1981505826 ps}
