...
add wave -noupdate -format Analog-Step -height 74 -max 126.99999999999997 -min -106.0 /STOSAvectorial_tb/data_magnitude_out
add wave -noupdate -format Analog-Step -height 74 -max 126.99999999999997 -min -128.0 -radix decimal -childformat {{/STOSAvectorial_tb/uut/CTRL_port(7) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(6) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(5) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(4) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(3) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(2) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(1) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_port(0) -radix decimal}} -expand -subitemconfig {/STOSAvectorial_tb/uut/CTRL_port(7) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(6) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(5) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(4) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(3) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(2) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(1) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_port(0) {-radix decimal}} /STOSAvectorial_tb/uut/CTRL_port
add wave -noupdate /STOSAvectorial_tb/CTRLsigned
add wave -noupdate -format Analog-Step -height 74 -max 123.99999999999999 -min -128.0 -radix decimal -childformat {{/STOSAvectorial_tb/uut/CTRL_output(7) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(6) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(5) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(4) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(3) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(2) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(1) -radix decimal} {/STOSAvectorial_tb/uut/CTRL_output(0) -radix decimal}} -subitemconfig {/STOSAvectorial_tb/uut/CTRL_output(7) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(6) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(5) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(4) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(3) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(2) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(1) {-radix decimal} /STOSAvectorial_tb/uut/CTRL_output(0) {-radix decimal}} /STOSAvectorial_tb/uut/CTRL_output
...
WaveRestoreCursors {{Cursor 1} {146200000 ps} 0}
...
update
WaveRestoreZoom {122205420 ps} {203675700 ps}
